...
╚═════════════════════╝
        ...
        try {
          ...
          if (m.limit) {
            m.reply('*『💵』 تم استخدام من فلوسك*' + +m.limit + '*جنية*');
          }
        }
        break;
      }
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*『👨‍💻』 لا يمكن استخدام هذا الأمر إلا من قبل مالك الروبوت.*',
    owner: '*『👨‍💻』 لا يمكن استخدام هذا الأمر إلا من قبل مالك الروبوت.*',
    mods: '*『⚖️』 لا يمكن استخدام هذا الأمر إلا من قبل المشرفين ومالك الروبوت.*',
    premium: '*『🦖』 لا يمكن استخدام هذا الأمر إلا من قبل المستخدمين المميزين ومالك الروبوت.*',
    group: '*『🌐』 لا يمكن استخدام هذا الأمر إلا في المجموعات.*',
    private: '*『🦥』 لا يمكن استخدام هذا الأمر إلا في الدردشة الخاصة للروبوت.*',
    admin: '*『😝』 لا يمكن استخدام هذا الأمر إلا من قبل مسؤولي المجموعة.*',
    botAdmin: '*『❕』 لاستخدام هذا الأمر، من الضروري أن يكون الروبوت مسؤولا عن المجموعة.*',
    unreg: '*『❕』 لاستخدام هذا الأمر، يجب أن تكون مسجلا.*\n\n*[ 💡 ] Use the command:* _#verify name.age_ *to register.*',
    restrict: '*『👨‍💻』 تم تعطيل هذا الأمر من قبل مالك الروبوت.*',
  }[type];
